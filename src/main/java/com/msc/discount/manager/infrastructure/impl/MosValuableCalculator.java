 ...
 */
public class MosValuableCalculator extends BasseCalclulator implements ICalculatorStrategy {

    public MosValuableCalculator(DiscountCalculatorService discountCalculatorService) {
